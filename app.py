...
# -----------------------------
# CORE MODELING LOGIC (FUNCTIONS UPDATED FOR ICD-10 BOOLEANS)
# -----------------------------
...
def calculate_bleeding_risk(age, inr, anticoagulant, gi_bleed, high_bp, antiplatelet_use, gender, weight, smoking, alcohol_use, antibiotic_order, dietary_change, has_liver_disease, has_stroke):
    ...
    score += 20 if has_liver_disease else 0  # Now uses ICD-derived boolean
    ...
    score += 15 if has_stroke else 0 # Now uses ICD-derived boolean
